                ...
                <div style={{paddingTop: "30px", paddingLeft: "60px", display: "flex", flexDirection: "row", flexGrow: 1}}>
                    <div style={{width: "45%", textAlign: "right"}}>
                        {this.props.canLinkLeft && this.props.summaryNumber === 1 &&
                            <Link className={"previous-next-link"} to={`/${this.props.year}/${this.props.race}/Q`}>
                                Previous
                            </Link>}
                        {this.props.canLinkLeft && this.props.summaryNumber !== 1 &&
                            <Link className={"previous-next-link"} to={`/${this.props.year}/${this.props.race}/${this.props.summaryNumber-1}`}>
                                Previous
                            </Link>}
                    </div>
